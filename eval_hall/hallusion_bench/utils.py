...
def evaluate_by_chatgpt(data, output_entry, correctness_entry, load_json=False, 
                        save_json_path="./hallusion_output.json", 
                        gpt_model=None, api_key=None):
...
def check_same_by_chatgpt(data, output_entry, load_json=False, 
                          save_json_path="./hallusion_output.json", 
                          gpt_model=None, api_key=None):
