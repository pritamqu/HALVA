...
def test_make_supervised_data_module(dataset_name, max_samples=-1, batch_size=32, num_workers=16, skip_before=0):
    ...
    from vila.data.dataset import make_supervised_data_module
    from vila.train.args import DataArguments, TrainingArguments
    from vila.model.multimodal_encoder.siglip.image_processing_siglip import SiglipImageProcessor
