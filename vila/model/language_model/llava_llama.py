...
class LlavaLlamaModel(LlavaMetaModel, LlavaMetaForCausalLM, PreTrainedModel):
    ...
    def forward(
        ...
        signs: Optional[bool] = None,
    ) -> Union[Tuple, CausalLMOutputWithPast]:
        

        # self.freezed_module_patch() # FIXME: this is another bs. set mode once and be done with it
        ...
        if inputs_embeds is None:
            ...
            if signs is not None:
                ...
                labels,
                signs,
                ) = self.prepare_inputs_labels_for_multimodal_signed(
                    input_ids, position_ids, attention_mask, past_key_values, labels, images, signs,
                )
        ...
        ## commenting this for HALVA; 
        ## this piece (repack_multimodal_data) of code is not stable and buggy
